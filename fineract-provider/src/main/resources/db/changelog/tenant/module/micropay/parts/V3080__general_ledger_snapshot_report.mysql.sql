--
-- MICROPAY CBS: General Ledger table report -- hybrid snapshot opening balance + currency filter (MariaDB / MySQL)
--
...
SELECT
  ...
  IF(lines.manual_entry = 1, lines.id, ''system'') AS transtype,
