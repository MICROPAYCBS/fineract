...
-- MICROPAY CBS: customer risk profile lookup (bank use / AML tier) — MySQL / MariaDB

INSERT INTO m_code (code_name, is_system_defined)
SELECT 'CustomerRiskProfile', 0
...
SELECT c.id, 'Very High', 'Very High', 1, 1, 0
FROM m_code c
