--
-- MICROPAY CBS: office servicing access matrix (PostgreSQL)
--
...
CREATE INDEX IF NOT EXISTS idx_osa_servicing_office ON m_office_servicing_access (servicing_office_id);
CREATE INDEX IF NOT EXISTS idx_osa_book_office ON m_office_servicing_access (book_office_id);
CREATE INDEX IF NOT EXISTS idx_osa_status ON m_office_servicing_access (status);
