...
-- MICROPAY CBS: Client income sources (PostgreSQL)
...
CREATE TABLE m_client_income_source (
    ...
    verified_by BIGINT,
    verified_on_utc TIMESTAMP WITH TIME ZONE,
...
CREATE UNIQUE INDEX uk_m_client_income_source_primary ON m_client_income_source (client_id)
    WHERE is_primary_source = 'Y';
