...
public interface AccountNumberFormatEngine {

    String generate(AccountNumberGenerationContext context);

    String buildScopeKey(AccountNumberGenerationContext context);
}
