...
public class GlBalanceSnapshotUpdateTasklet implements Tasklet {
    ...
    public RepeatStatus execute(final StepContribution contribution, final ChunkContext chunkContext) {
        ...
        final int rows = glBalanceSnapshotWritePlatformService.updateSnapshotsIncrementally(jobExecutionId);
