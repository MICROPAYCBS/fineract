...
public interface ShareAccountApiConstants {
    ...
    String usesavings_paramname = "useSavings";
    ...
    Set<String> supportedParameters = Collections.unmodifiableSet(new HashSet<>(Arrays.asList(locale_paramname, dateformat_paramname,
            ...
            savingsaccountid_paramname, usesavings_paramname, lockinperiod_paramname, lockperiodfrequencytype_paramname,
            ...
            numberofshares_paramname, purchasedprice_paramname)));
