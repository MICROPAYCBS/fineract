 ...
 * under the License.
 */
package org.apache.fineract.portfolio.industry.domain;
...
@Setter
@NoArgsConstructor
public class Industry extends AbstractAuditableWithUTCDateTimeCustom<Long> {

    @Column(name = "industry_code", length = 20, nullable = false, unique = true)
    ...
    @Column(name = "priority_industry_flag", length = 1)
    private String priorityIndustryFlag = "N";

    @Column(name = "prohibited_industry_flag", length = 1)
    private String prohibitedIndustryFlag = "N";
