...
public interface DepartmentWritePlatformService {
    ...
    CommandProcessingResult updateDepartment(Long departmentId, JsonCommand command);

    CommandProcessingResult deleteDepartment(Long departmentId, JsonCommand command);

    Department findWithNotFoundDetection(Long departmentId);
}
