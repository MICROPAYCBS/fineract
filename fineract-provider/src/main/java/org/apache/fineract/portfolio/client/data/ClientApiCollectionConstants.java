...
public class ClientApiCollectionConstants extends ClientApiConstants {
    ...
    protected static final Set<String> CLIENT_CREATE_REQUEST_DATA_PARAMETERS = new HashSet<>(Arrays.asList(familyMembers, incomeSources,
            ...
            maritalStatusIdParamName, firstnameParamName, middlenameParamName, lastnameParamName, fullnameParamName, officeIdParamName,
    ...
    protected static final Set<String> CLIENT_UPDATE_REQUEST_DATA_PARAMETERS = new HashSet<>(Arrays.asList(localeParamName,
            ...
            customerClassIdParamName, titleIdParamName, nationalityCountryIdParamName, customerRiskProfileIdParamName,
            maritalStatusIdParamName, firstnameParamName,
            middlenameParamName,
            ...
            clientNonPersonDetailsParamName, displaynameParamName, isStaffParamName));
