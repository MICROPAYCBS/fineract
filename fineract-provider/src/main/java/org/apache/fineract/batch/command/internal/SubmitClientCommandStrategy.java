...
/**
 * Implements {@link CommandStrategy} to handle submission of a draft client for activation.
 */
@Component
@RequiredArgsConstructor
public class SubmitClientCommandStrategy implements CommandStrategy {
    ...
    public BatchResponse execute(final BatchRequest request, @SuppressWarnings("unused") UriInfo uriInfo) {
        ...
        responseBody = clientsApiResource.activate(clientId, "submit", request.getBody() == null ? "{}" : request.getBody());
